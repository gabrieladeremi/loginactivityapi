...
abstract class Model implements Arrayable, ArrayAccess, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
    ...
    /**
     * The list of models model that should not be affected with touch.
     *
     * @var array
     */
    ...
    /**
     * Disables relationship model touching for the given model model during given callback scope.
     *
     * @param  array  $models
     * @param  callable  $callback
     * @return void
